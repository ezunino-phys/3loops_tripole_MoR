...
$AROptions={TimeConstraint->Infinity,"UseKira"->True,FileBaseName->"4Pole3LoopRegionM2"};
...
Regionm2=Sum[Simplify[intppCoLL[[i]]*lam^(2eps)]/.lam^x_->0,{i,1,Length[intppCoLL]}]
RegionExpm2=Simplify[Normal[Series[Regionm2,{lam,0,0}]]]
Reducedm2=Map[Simplify,Collect[DoKira[RegionExpm2],AlphaInt[__]]]
ReducedEvam2=AlphaIntEvaluate[Reducedm2]
DiffEvam2aIJ=AlphaDES[Cases2[Reducedm2,AlphaInt[__]],aIJ]
DiffEvam2yIJK=AlphaDES[Cases2[Reducedm2,AlphaInt[__]],SQRTyIJK]
ExplicitExpm2=AlphaIntExplicit[Cases2[Reducedm2,AlphaInt[__]]]
SetDirectory["/home/s2894494"];
DumpSave["4Pole3LoopRegionM6sum.mx",{Regionm2,RegionExpm2,Reducedm2,ReducedEvam2,DiffEvam2aIJ,DiffEvam2yIJK,ExplicitExpm2}];

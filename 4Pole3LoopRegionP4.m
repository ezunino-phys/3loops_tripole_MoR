...
$AROptions={TimeConstraint->Infinity,"UseKira"->True,FileBaseName->"4Pole3LoopRegionP4"};
...
Regionp4=Sum[Simplify[intppCoLL[[i]]*lam^(-4eps)]/.lam^x_->0,{i,1,Length[intppCoLL]}]
RegionExpp4=Simplify[Normal[Series[Regionp4,{lam,0,0}]]]
Reducedp4=Map[Simplify,Collect[DoKira[RegionExpp4],AlphaInt[__]]]
ReducedEvap4=AlphaIntEvaluate[Reducedp4]
DiffEvap4aIJ=AlphaDES[Cases2[Reducedp4,AlphaInt[__]],aIJ]
DiffEvap4yIJK=AlphaDES[Cases2[Reducedp4,AlphaInt[__]],SQRTyIJK]
ExplicitExpp4=AlphaIntExplicit[Cases2[Reducedp4,AlphaInt[__]]]
SetDirectory["/home/s2894494"];
DumpSave["4Pole3LoopRegionP4.mx",{Regionp4,RegionExpp4,Reducedp4,ReducedEvap4,DiffEvap4aIJ,DiffEvap4yIJK,ExplicitExpp4}];

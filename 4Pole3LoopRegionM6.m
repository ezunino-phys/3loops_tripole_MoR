...
$AROptions={TimeConstraint->Infinity,"UseKira"->True,FileBaseName->"4Pole3LoopRegionM6"};
...
Regionm6=Sum[Simplify[intppCoLL[[i]]*lam^(6eps)]/.lam^x_->0,{i,1,Length[intppCoLL]}]
RegionExpm6=Simplify[Normal[Series[Regionm6,{lam,0,0}]]]
Reducedm6=Map[Simplify,Collect[DoKira[RegionExpm6],AlphaInt[__]]]
ReducedEvam6=AlphaIntEvaluate[Reducedm6]
DiffEvam6aIJ=AlphaDES[Cases2[Reducedm6,AlphaInt[__]],aIJ]
DiffEvam6yIJK=AlphaDES[Cases2[Reducedm6,AlphaInt[__]],SQRTyIJK]
ExplicitExpm6=AlphaIntExplicit[Cases2[Reducedm6,AlphaInt[__]]]
SetDirectory["/home/s2894494"];
DumpSave["4Pole3LoopRegionM6sum.mx",{Regionm6,RegionExpm6,Reducedm6,ReducedEvam6,DiffEvam6aIJ,DiffEvam6yIJK,ExplicitExpm6}];

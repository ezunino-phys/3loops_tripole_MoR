...
$AROptions={TimeConstraint->Infinity,"UseKira"->True,FileBaseName->"4Pole3LoopRegionP2"};
...
Regionp2=Sum[Simplify[intppCoLL[[i]]*lam^(-2eps)]/.lam^x_->0,{i,1,Length[intppCoLL]}]
RegionExpp2=Simplify[Normal[Series[Regionp2,{lam,0,0}]]]
Reducedp2=Map[Simplify,Collect[DoKira[RegionExpp2],AlphaInt[__]]]
ReducedEvap2=AlphaIntEvaluate[Reducedp2]
DiffEvap2aIJ=AlphaDES[Cases2[Reducedp2,AlphaInt[__]],aIJ]
DiffEvap2yIJK=AlphaDES[Cases2[Reducedp2,AlphaInt[__]],SQRTyIJK]
ExplicitExpp2=AlphaIntExplicit[Cases2[Reducedp2,AlphaInt[__]]]
SetDirectory["/home/s2894494"];
DumpSave["4Pole3LoopRegionP2.mx",{Regionp2,RegionExpp2,Reducedp2,ReducedEvap2,DiffEvap2aIJ,DiffEvap2yIJK,ExplicitExpp2}];
